...
export type Contract<T extends SwapAsset> = {
    ...
    direction: 'send' | 'receive';
    status: ContractStatus;
    htlc: T extends SwapAsset.NIM ? NimHtlcDetails : T extends SwapAsset.BTC ? BtcHtlcDetails : T extends SwapAsset.BTC_LN ? BtcLnHtlcDetails : T extends SwapAsset.USDC | SwapAsset.USDC_MATIC | SwapAsset.USDT_MATIC ? Erc20HtlcDetails : T extends SwapAsset.EUR ? EurHtlcDetails : never;
};
