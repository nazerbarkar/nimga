const PERIODS = ['month', 'day', 'hour', 'minute', 'second']; // sorted long to short
var Priority;
(function (Priority) {
    Priority["LOW"] = "low";
    Priority["HIGH"] = "high";
...
const ONE_MINUTE$1 = 60 * ONE_SECOND$1;
const ONE_HOUR$1 = 60 * ONE_MINUTE$1;
const ONE_DAY$1 = 24 * ONE_HOUR$1;
    ...
    setRateLimits(rateLimits) {
        ...
        for (let i = PERIODS.length - 1; i >= 0; --i) { // Iterate from shorter periods to longer periods.
            ...
            if (!rateLimits[period])
                continue;
            const periodDuration = period !== 'month' ? PERIOD_DURATION[period] : 28 * ONE_DAY$1; // conservative duration
 ...
 */
function setCoinGeckoApiUrl(url = 'https://api.coingecko.com/api/v3') {
...
async function getExchangeRates(cryptoCurrencies, vsCurrencies, provider = Provider.CryptoCompare) {
 ...
 */
async function getHistoricExchangeRates(cryptoCurrency, vsCurrency, timestamps, provider = Provider.CryptoCompare, options = {}) {
...
export { CryptoCurrency as C, FiatCurrency as F, Provider as P, RateType as R, setCoinGeckoApiExtraHeader as a, getHistoricExchangeRatesByRange as b, getHistoricExchangeRates as c, isBridgeableFiatCurrency as d, isBridgedFiatCurrency as e, isHistorySupportedFiatCurrency as f, getExchangeRates as g, Priority as h, isProviderSupportedFiatCurrency as i, RateLimitScheduler as j, setCoinGeckoApiUrl as s };
//# sourceMappingURL=FiatApi-QpZDxyIr.js.map
